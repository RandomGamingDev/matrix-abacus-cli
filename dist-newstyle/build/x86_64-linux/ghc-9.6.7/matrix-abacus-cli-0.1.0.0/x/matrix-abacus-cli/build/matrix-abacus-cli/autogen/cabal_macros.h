...
/* package matrix-abacus-cli-0.1.0.0 */
#ifndef VERSION_matrix_abacus_cli
#define VERSION_matrix_abacus_cli "0.1.0.0"
#endif /* VERSION_matrix_abacus_cli */
#ifndef MIN_VERSION_matrix_abacus_cli
#define MIN_VERSION_matrix_abacus_cli(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_matrix_abacus_cli */
...
#define CURRENT_COMPONENT_ID "matrix-abacus-cli-0.1.0.0-inplace-matrix-abacus-cli"
